...
import { MapPin, AlertTriangle, Clock, Users, ZoomIn, ArrowLeft } from 'lucide-react';
    ...
    <div className="bg-white rounded-lg shadow">
      ...
      <div className="p-6">
        {!zoomedRegion ? (
            ...
            {cameroonRegions.map((region) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Nom de la région */}
                  <div className="absolute top-10 left-1/2 transform -translate-x-1/2 text-xs font-medium text-gray-700 whitespace-nowrap">
                    {region.name}
                  </div>
                </div>
              );
          ...
          // Vue zoomée d'une région spécifique
                ...
                >
                  <div className={`relative ${
                    ...
                    <div className={`w-4 h-4 rounded-full border border-white shadow-md ${getSiteStatusColor(site.status)} ${
                      siteOutages.length > 0 ? 'ring-2 ring-red-300' : ''
        ...
        <div className="mt-6 flex items-center justify-between">
            ...
            {!zoomedRegion ? (
              ...
              <>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">Site hors ligne</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
          ...
          <div className="text-xs text-gray-500">
            {!zoomedRegion ? (
              '🔍 Cliquez sur une région pour zoomer et voir les sites'
            ) : (
        ...
        {/* Liste des pannes actives pour la vue pays */}
