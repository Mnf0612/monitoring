...
ROOT_URLCONF = 'bts_monitoring.urls'
...
# For PostgreSQL (when you have it set up):
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': config('DB_NAME', default='bts_monitoring'),
...
# For Redis (when you have it set up):
# CHANNEL_LAYERS = {
#     'default': {
